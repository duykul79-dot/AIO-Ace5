...
This module includes a Zygisk component under the `zygisk/` directory.
...
2. Verify the SHA256 checksum if a `.sha256` file is provided.
3. Flash the module through KernelSU, Magisk, or APatch.
4. Reboot the device after flashing.
5. Enable Zygisk if your root environment supports it and the feature requires it.
6. Reboot again if you have just enabled Zygisk.
7. Open the module WebUI from your root/module manager.
8. Use each tab as needed.

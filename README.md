...
Cài đặt
Tải file .zip từ mục GitHub Releases.
Kiểm tra SHA256 nếu có file .sha256 đi kèm.
Flash module bằng KernelSU, Magisk hoặc APatch.
Khởi động lại thiết bị sau khi flash.
Bật Zygisk nếu môi trường root có hỗ trợ và module/tính năng yêu cầu.
Khởi động lại thêm một lần nếu vừa bật Zygisk.
Mở WebUI của module trong trình quản lý root/module.
Sử dụng từng tab theo nhu cầu.
Gỡ cài đặt
